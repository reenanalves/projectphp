...
class AddressController
{
    ...
    public function POSTaddressV1($parameters)
    {
        try {

            $request = new POSTaddressV1Request();
    ...
    public function PUTaddressV1($parameters)
    {
        try {

            $request = new PUTaddressV1Request();
            $request->setValues($parameters);
            $request->validate();
    ...
    public function GETAddressesV1($parameters)
    {
        try {
            ...
            $data = AddressService::loadAll($request->IdCustomer, $request->Page, $request->RecordsByPage);
            ...
            $response->TotalRecords = AddressService::countAllRecords($request->IdCustomer);
