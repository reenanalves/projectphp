...
class Router extends Routes{
    ...
    public function __construct(){
        ...
        */    
        $this->registerRoute(new Route(new URI("customer", "v1", ""),"CustomerController","POSTANDPUTCustomerV1", true),HTTPVerbs::POST);        
        ...
        $this->registerRoute(new Route(new URI("address", "v1", ""),"UserController","POSTANDPUTaddressV1", true),HTTPVerbs::POST);        
        ...
        $this->registerRoute(new Route(new URI("address", "v1", ""),"UserController","GETAddressV1", true),HTTPVerbs::GET);        
        $this->registerRoute(new Route(new URI("addresses", "v1", ""),"UserController","GETAddressesV1", true),HTTPVerbs::GET);  
    }
