...
class Router extends Routes{
    ...
    public function __construct(){
        ...
        */    
        ...
        $this->registerRoute(new Route(new URI("address", "v1", ""),"AddressController","POSTANDPUTaddressV1", true),HTTPVerbs::POST);        
        $this->registerRoute(new Route(new URI("address", "v1", ""),"AddressController","POSTANDPUTaddressV1", true),HTTPVerbs::PUT);  
